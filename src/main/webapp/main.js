				...
				React.DOM.div({className: "row clearfix"}, 
					React.DOM.div({className: "col-md-12 column"}, 
						React.DOM.div({className: "jumbotron"}, 
							React.DOM.h2(null, "MARC 21 to RDF-DC metadata transformer"), 
							      React.DOM.p(null, "This web service allows you to convert MARC21 records to the RDF-DC format."),
							      React.DOM.hr(null), 
						...
						React.DOM.pre(null, "$ curl -d @input.marc21.xml -o output.rdfdc.xml http://weblicht.sfs.uni-tuebingen.de/converter/Marc2RDFDC/rest"
						)
					)
				)
			)
...
var DownloadBox = React.createClass({displayName: 'DownloadBox',
	...
	render: function() {
		...
		var header = $.isEmptyObject(files) ? (React.DOM.span(null)) : (React.DOM.p(null, "Download generated RDF-DC file: "));
